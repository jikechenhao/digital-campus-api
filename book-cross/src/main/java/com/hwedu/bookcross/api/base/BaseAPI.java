package com.hwedu.bookcross.api.base;
...
public class BaseAPI {
    ...
    protected Map<String, Object> normalResult(String message, Object... objs) {
        ...
        result.put("code", Variables.getInstance().getResultCodeNormal());
    ...
    protected CheckException checkException(String message) {
        return new CheckException(Variables.getInstance().getResultCodeError(), message);
    }
